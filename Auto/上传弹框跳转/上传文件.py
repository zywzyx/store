...
# 打开百度网址
chromeDriver.get("F:\PythonCode\python\Auto\上传弹框跳转\\autotest.html")
...
# 上传文件
chromeDriver.find_element_by_name('file').send_keys('F:\PythonCode\python\Auto\上传弹框跳转\qwq.png')
# 弹窗
