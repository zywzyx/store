...
from  brank import ABC


# 1.准备一个数据库 和 银行名称
bank = {2233: {'username': '1', 'password': '1', 'country': '1', 'province': '1', 'street': '1', 'gate': '1', 'genre': 1, 'money': 100, 'bank_name': '中国农业银行昌平沙河支行'}}  # 空的数据库
